...
import org.somak.messenger.model.Comment;
...
public class CommentService {
	...
	public Comment getComment(long messageId, long commentId) {
		...
		ErrorMessage errmsg=new ErrorMessage("Not Found",404,"https://ndtv.com");
		Response resp=Response.status(Status.NO_CONTENT).entity(errmsg).build();
